 ...
 * @class org.ekstep.questionunit.sequencing
...
org.ekstep.questionunitseq.RendererPlugin = org.ekstep.contentrenderer.questionUnitPlugin.extend({
  _type: 'org.ekstep.questionunit.sequencing',
  _isContainer: true,
  _render: true,
  _selectedAnswers: [],
  _dragulaContainers: [],
  ...
  evaluateQuestion: function(event){
    ...
    var result = {
      ...
      state: {
        val: {
          "sequencing": this._question.data.options
        }
      },
      score: partialScore,
...
//# sourceURL=questionunit.sequencing.renderer.plugin.js